...
const DeleteButton = ({ handleSubmit }: DeleteButtonProps) => {
  ...
  return (
    <button
      onClick={onClick}
      className="px-4 py-2 mt-10 text-white rounded bg-red-500 hover:bg-red-600 dark:bg-red-700 dark:hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-500"
    >
